export const translations = {
  ...
  tr: {
    pageTabTitle: "Goldbet Casino Hesabı Kaydı",
    backBtn: "Geri",
    // | Step 1
    step1Title: "Bonusu Seçin",
    welcomeBonus: "Hoşgeldin Bonusu",
    welcomeBonusText: "ilk yatırımınıza özel",
    cryptoBonus: "Satoshi Bonusu",
    cryptoBonusText: "Kripto Para Yatırımlarına %150 Bonus",
    highRollerBonus: "High Roller Bonusu",
    highRollerBonusText: `500<span class="bonus-currency-symbol"></span> üzeri yatırımlara %250 bonus`,
    ...
    youWillGetFreeSpins: "Bedava döndürmeler kazanacaksınız",
    ...
    birthdayPlaceholder: "Doğum Tarihinizi Seçin",
    age18Alert: "Yaşınız 18+ olmalıdır",
    invalidDate: "Geçersiz tarih",
    male: "Erkek",
    female: "Kadın",
    finalStepBtn: "Son Adım",
    // | Step 4
    step4Title: "Para Birimini Seçin",
    ...
    statePlaceholder: "Bölge Seçin",
    zipCodePlaceholder: "Posta Kodu Girin",
    createAccountBtn: "Hesap Oluştur",
  },
  ru: {
    pageTabTitle: "Регистрация Аккаунта в Казино Goldbet",
    backBtn: "Назад",
    // | Step 1
    step1Title: "Выберите Ваш Бонус",
    welcomeBonus: "Приветственный Бонус",
    welcomeBonusText: "на ваш первый депозит",
    cryptoBonus: "Satoshi Бонус",
    cryptoBonusText: "150% на депозиты в криптовалюте",
    highRollerBonus: "Бонус для High Roller",
    highRollerBonusText: `250% на депозиты свыше <span class="bonus-highroller-amount">500</span><span class="bonus-currency-symbol"></span>`,
    withoutBonus: "Без Бонуса",
    withoutBonusText: "Вы не получите бонус",
    iHavePromoCode: "У меня есть промокод",
    promoCodePlaceHolder: "Промокод",
    promoCodeApplyBtn: "Применить",
    youWillGetFreeSpins: "Вы получите бесплатные вращения",
    youWillGetNodepBonus: "Вы получите бездепозитный бонус",
    continueBtn: "Продолжить",
    // | Step 2
    step2Title: "Введите Ваш Email",
    emailPlaceholder: "Введите E-mail",
    passwordPlaceholder: "Введите Пароль",
    // | Step 3
    step3Title: "Как Вас зовут?",
  ...
  uk: {
    ...
    highRollerBonus: "Бонус для хайролерів",
    ...
    iHavePromoCode: "У мене є промо-код",
