export const translations = {
  ...
  it: {
    ...
    pageTabTitle: "Registra un conto Goldbet Casino",
    backBtn: "Indietro",
    // | Step 1
    ...
    welcomeBonusText: "sul primo deposito",
    cryptoBonus: "Bonus Satoshi",
    ...
    birthdayPlaceholder: "Scegli la data di nascita",
    age18Alert: "L'età deve essere 18+",
    invalidDate: "Data non valida",
    male: "Uomo",
    female: "Donna",
    finalStepBtn: "Ultimo passaggio",
    // | Step 4
    step4Title: "Scegli la valuta",
    countryPlaceholder: "Scegli il paese",
    currencyPlaceholder: "Scegli la valuta",
    phoneNumberPlaceholder: "Numero di telefono",
    addressPlaceholder: "Inserisci l'indirizzo",
    cityPlaceholder: "Inserisci la città",
    statePlaceholder: "Scegli la regione",
    zipCodePlaceholder: "Inserisci il CAP",
    createAccountBtn: "Crea un conto",
    // | Checken road
    chickenRoadGetBonus: "Ottieni il bonus",
    chickenRoadAccepted: "Accettato",
    chickenRoadPlaying: "In gioco",
    checkenRoadSubtitle: "Registrati e ottieni il tuo bonus",
    chickenRoadMainTitle: `<span class='two-step-welcome-amount blurred text-[#FFF67D]'>4.500</span> <span class='two-step-welcome-symbol blurred text-[#FFF67D]'>€</span> + <span class='two-step-bonus-spins blurred text-[#30FF7E]'>200 FS</span> <br/> bonus per i nuovi giocatori`,
    // ? SOCIALS
    signUpEasySteps: "Registrati in 3 semplici passaggi",
    completeToClaimGift: "Completa e ricevi il tuo regalo.",
    ...
    depositBonus: `Fino a <span class="two-step-welcome-amount"></span> <span class="two-step-welcome-symbol"></span> + <span class="two-step-bonus-spins"></span>`,
    ...
    currency: "Valuta",
    terms: `<a href="https://dev1.goldbet.io/terms-and-conditions" class="text-white underline underline-offset-4" >Accetto i termini e le condizioni</a></span>`,
    ...
    step2Title: `Ultimo passaggio per ottenere il bonus`,
    step2Subtitle: `Crea una password e scegli la valuta del conto.`,
    passwordPlaceholder: "Password",
    // | Terms
    termsTitle1: `Termini e Condizioni`,
    termsParagraph1: `Questi termini e condizioni ("Termini") si applicano all'utilizzo di questo sito web ("Sito") e dei servizi correlati ("Servizio"). Leggili attentamente, poiché definiscono i tuoi diritti e obblighi e costituiscono un accordo legale tra te (il Cliente) e noi (il Sito). Utilizzando il Sito e/o accedendo al Servizio, accetti questi Termini e le relative modifiche. Se non li accetti, non utilizzare il Servizio.`,
    termsTitle2: `1. Condizioni generali`,
    termsParagraph2: `Possiamo modificare i Termini in qualsiasi momento. Controlla regolarmente questa pagina. Le modifiche entrano in vigore immediatamente dopo la pubblicazione sul Sito. Se non sei d'accordo, interrompi l'utilizzo. Continuare a utilizzare il Servizio significa che accetti le modifiche. Le scommesse effettuate prima dell'entrata in vigore restano soggette ai Termini precedenti. Se Goldbet aggiorna i Termini, riceverai una notifica e ti verrà richiesta una conferma.`,
    termsTitle3: `2. I tuoi obblighi`,
    termsParagraph3: `Confermi che: <br />
                      3.1. Hai più di 18 anni. Possiamo richiedere un documento. <br />
                      3.2. Hai la capacità giuridica e puoi stipulare un contratto. <br />
                      3.3. In alcuni paesi questi servizi possono essere illegali. La responsabilità è tua. Paesi vietati: Afghanistan, Algeria, ... , Zimbabwe ecc. <br />
                      3.4. È tua responsabilità verificare la legalità del gioco d'azzardo quando apri un conto. <br />
                      3.5. Sei il titolare del metodo di pagamento e i fondi sono di provenienza lecita. <br />
                      3.6. Devi effettuare i pagamenti in buona fede. <br />
                      3.7. Scommettendo puoi perdere denaro. <br />
                      3.8. Non devi utilizzare informazioni ottenute illecitamente. <br />
                      3.9. Partecipi esclusivamente per scopi personali. <br />
                      3.10. Non devi manipolare il Servizio. <br />
                      3.11. Devi agire in buona fede. <br />
                      3.12. Tu e i tuoi familiari non partecipate al programma Affiliate. <br />
                      3.13. Devi fornire solo informazioni veritiere. <br />
                      3.14. Accetti la volatilità del mercato delle criptovalute. <br />
                      3.15. Non hai dipendenza dal gioco d'azzardo. <br />
                      3.16. Non devi utilizzare software di terze parti. <br />
                      3.17. Confermi che i dati forniti sono corretti. <br />
                      3.17.1. Non puoi modificare i dati autonomamente, devi contattare l'assistenza. <br />
                      3.18. Non utilizzerai il Servizio in giurisdizioni vietate. <br />
                      3.19. Confermi che: <br />
                      - Utilizzi il Servizio solo per tuo conto; <br />
                      - Le imposte sulle vincite sono a tuo carico; <br />
                      - Gli obblighi relativi alle criptovalute sono a tuo carico.`,
  },
  et: {
  ...
  sw: {
    depositBonusDynamic: `Bonasi bila amana <span class="bonus-sum-amount text-[#FFF67D]"></span> <span class="bonus-sum-currency text-[#FFF67D]"></span>`,
    pageTabTitle: "Fungua akaunti ya Goldbet Casino",
    backBtn: "Rudi",
    // | Step 1
    depToBalance: `<span><i class="actual-spin-amount">100</i> MIZUNGUKO BURE</span>`,
    ...
    youWillGetFreeSpins: "Utapata mizunguko bure",
    ...
    cityPlaceholder: "Weka mji",
    statePlaceholder: "Chagua mkoa",
    zipCodePlaceholder: "Weka msimbo wa posta",
    createAccountBtn: "Fungua akaunti",
    // | Checken road
    chickenRoadGetBonus: "Pata bonasi",
    chickenRoadAccepted: "Imekubaliwa",
    chickenRoadPlaying: "Wanacheza",
    heroTitle: `pata bonasi yako <br/> <span class="text-[#30FF7E]"><i class="actual-spin-amount">100</i> mizunguko bure</span> <br/> katika <span>big bass splash</span>`,
    checkenRoadSubtitle: "Jisajili na upate bonasi yako",
  },
  rw: {
  ...
  ga: {
    depositBonusDynamic: `Bónas gan éarlais <span class="bonus-sum-amount text-[#FFF67D]"></span> <span class="bonus-sum-currency text-[#FFF67D]"></span>`,
    ...
    heroTitle: `faigh do bhónas <br/> <span class="text-[#30FF7E]"><i class="actual-spin-amount">100</i> casadh saor in aisce</span> <br/> i <span>big bass splash</span>`,
    checkenRoadSubtitle: "Cláraigh agus éiligh do bhónas",
  },
  lb: {
    depositBonusDynamic: `Bonus ouni Depot <span class="bonus-sum-amount text-[#FFF67D]"></span> <span class="bonus-sum-currency text-[#FFF67D]"></span>`,
    pageTabTitle: "Mellt Iech un fir e Goldbet Casino Kont",
    backBtn: "Zréck",
    // | Step 1
    depToBalance: `<span><i class="actual-spin-amount">100</i> GRATIS DRÉIUNGEN</span>`,
    ...
    highRollerBonus: "High Roller Bonus",
    highRollerBonusText: `200% op Depoten iwwer <span class="bonus-highroller-amount"></span> <span class="two-step-welcome-symbol"></span>`,
    ...
    heroTitle: `huel däi Bonus <br/> <span class="text-[#30FF7E]"><i class="actual-spin-amount">100</i> gratis Dréiungen</span> <br/> am <span>big bass splash</span>`,
    checkenRoadSubtitle: "Mellt Iech un a frot Äre Bonus un",
  },
  mt: {
    depositBonusDynamic: `Bonus mingħajr depożitu <span class="bonus-sum-amount text-[#FFF67D]"></span> <span class="bonus-sum-currency text-[#FFF67D]"></span>`,
    ...
    highRollerBonus: "Bonus High Roller",
    highRollerBonusText: `200% fuq depożiti ‘l fuq minn <span class="bonus-highroller-amount"></span> <span class="two-step-welcome-symbol"></span>`,
    ...
    // | Checken road
    chickenRoadGetBonus: "Ikseb Bonus",
    chickenRoadAccepted: "Aċċettat",
    chickenRoadPlaying: "Qed Tilgħab",
    heroTitle: `ikseb il-bonus tiegħek <br/> <span class="text-[#30FF7E]"><i class="actual-spin-amount">100</i> spins b’xejn</span> <br/> f’<span>big bass splash</span>`,
    checkenRoadSubtitle: "Irreġistra u ikseb il-bonus tiegħek",
  },
  nl: {
    depositBonusDynamic: `Bonus zonder storting <span class="bonus-sum-amount text-[#FFF67D]"></span> <span class="bonus-sum-currency text-[#FFF67D]"></span>`,
    pageTabTitle: "Meld je aan voor een Goldbet Casino-account",
    backBtn: "Terug",
    // | Step 1
    depToBalance: `<span><i class="actual-spin-amount">100</i> GRATIS SPINS</span>`,
    ...
    youWillGetFreeSpins: "Je krijgt gratis spins",
    youWillGetNodepBonus: "Je krijgt een bonus zonder storting",
    ...
    // | Checken road
    chickenRoadGetBonus: "Ontvang bonus",
    chickenRoadAccepted: "Geaccepteerd",
    chickenRoadPlaying: "Aan het spelen",
    heroTitle: `claim je bonus <br/> <span class="text-[#30FF7E]"><i class="actual-spin-amount">100</i> gratis spins</span> <br/> in <span>big bass splash</span>`,
    checkenRoadSubtitle: "Meld je aan en claim je bonus",
  },
  zh: {
  ...
  am: {
    ...
    heroTitle: `ቦነስዎን ይቀበሉ <br/> <span class="text-[#30FF7E]"><i class="actual-spin-amount">100</i> ነጻ ስፒኖች</span> <br/> በ <span>big bass splash</span>`,
  ...
  lm: {
    ...
    lastNamePlaceholder: "Erinnya ry'omuryango",
  ...
  ha: {
    ...
    lastNamePlaceholder: "Sunan Biyu",
