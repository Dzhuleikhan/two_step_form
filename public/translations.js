export const translations = {
  ...
  uz: {
    ...
    welcomeBonusText: "birinchi depozit uchun",
    cryptoBonus: "Satoshi bonusi",
    cryptoBonusText: "Kripto depozitlar uchun 150%",
    highRollerBonus: "High Roller bonusi",
    highRollerBonusText: `Depozitlar uchun 200% <span class="bonus-highroller-amount"></span> <span class="two-step-welcome-symbol"></span> dan ortiq`,
    withoutBonus: "Bonussiz",
    withoutBonusText: "Hech qanday bonus olmaysiz",
    iHavePromoCode: "Promokodim bor",
    ...
    // | Step 2
    step2Title: "Emailingizni kiriting",
    ...
    birthdayPlaceholder: "Tug‘ilgan kuningizni tanlang",
    age18Alert: "Yosh 18+ bo‘lishi kerak",
    invalidDate: "Noto‘g‘ri sana",
    male: "Erkak",
    female: "Ayol",
    finalStepBtn: "So‘nggi qadam",
    // | Step 4
    step4Title: "Valutani tanlang",
    countryPlaceholder: "Mamlakatni tanlang",
    currencyPlaceholder: "Valutani tanlang",
  ...
  az: {
    ...
    welcomeBonusText: "ilk depozitində",
    cryptoBonus: "Satoshi Bonusu",
    ...
    withoutBonus: "Bonussuz",
    withoutBonusText: "Bonus almayacaqsan",
    iHavePromoCode: "Promo-Kodum Var",
    promoCodePlaceHolder: "Promo Kod",
    promoCodeApplyBtn: "Təsdiqlə",
    youWillGetFreeSpins: "Pulsuz fırlanma qazanacaqsan",
    youWillGetNodepBonus: "Depozitsiz bonus qazanacaqsan",
    continueBtn: "Davam Et",
    // | Step 2
    step2Title: "Email Ünvanını Daxil Et",
    emailPlaceholder: "E-mail daxil et",
    passwordPlaceholder: "Şifrə daxil et",
    // | Step 3
    step3Title: "Adın Nədir?",
    namePlaceholder: "Adını daxil et",
    lastNamePlaceholder: "Soyadını daxil et",
    birthdayPlaceholder: "Doğum Tarixini Seç",
    ...
    // | Step 4
    step4Title: "Valyuta Seç",
    countryPlaceholder: "Ölkə Seç",
    currencyPlaceholder: "Valyuta Seç",
    phoneNumberPlaceholder: "Telefon Nömrəsi",
    addressPlaceholder: "Ünvan Daxil Et",
    cityPlaceholder: "Şəhər Daxil Et",
    statePlaceholder: "Vilayət Seç",
    zipCodePlaceholder: "ZIP Kod Daxil Et",
