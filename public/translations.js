export const translations = {
  ...
  it: {
    ...
    pageTabTitle: "Registrati per un conto Goldbet Casino",
    backBtn: "Indietro",
    // | Step 1
    ...
    birthdayPlaceholder: "Seleziona la data di nascita",
    ...
    // | Checken road
    chickenRoadGetBonus: "Ottieni bonus",
    ...
    completeToClaimGift: "Completa e ritira il tuo regalo.",
    ...
    depositBonus2: "400% sui depositi fino a 6000",
    phoneNumber: "Numero di telefono",
    password: "Password",
    minSymbols: "Minimo 6 caratteri",
    atLeast6Chars: "Almeno 6 caratteri",
    currency: "Valuta",
    terms: `<a href="https://dev1.goldbet.io/terms-and-conditions" class="text-white underline underline-offset-4" >Accetto i Termini e Condizioni</a></span>`,
    ...
    step2Subtitle: `Crea una password e seleziona la valuta.`,
    passwordPlaceholder: "Password",
    // | Terms
    termsTitle1: `Termini e Condizioni`,
    termsParagraph1: `I presenti termini e condizioni ("Termini") si applicano all'uso di questo sito web ("Sito") e dei relativi servizi ("Servizio"). Leggi attentamente questi Termini, poiché definiscono i tuoi diritti e obblighi e costituiscono un accordo legale tra te (il Cliente) e noi (il Sito). Utilizzando il Sito e/o accedendo al Servizio, accetti i presenti Termini e le loro modifiche. Se non li accetti, non utilizzare il Servizio.`,
    termsTitle2: `1. Condizioni generali`,
    termsParagraph2: `Possiamo modificare i Termini in qualsiasi momento. Controlla questa pagina regolarmente. Le modifiche entrano in vigore immediatamente dopo la pubblicazione sul Sito. Se non sei d'accordo, interrompi l'utilizzo. Continuare a utilizzare il Servizio significa che accetti le modifiche. Le scommesse effettuate prima dell'entrata in vigore restano soggette ai Termini precedenti. Se i Termini di Goldbet vengono aggiornati, riceverai una notifica e ti sarà richiesta la conferma.`,
    termsTitle3: `2. I tuoi obblighi`,
    termsParagraph3: `Dichiari e garantisci che: <br />
                      3.1. Hai più di 18 anni. Possiamo richiedere un documento. <br />
                      3.2. Hai la capacità giuridica e puoi stipulare contratti. <br />
                      ...
                      3.4. Nell'aprire un conto, è tua responsabilità verificare la legalità del gioco d'azzardo. <br />
                      ...
                      3.12. Né tu né i tuoi familiari fate parte del programma Affiliate. <br />
                      3.13. Devi fornire esclusivamente informazioni veritiere. <br />
                      3.14. Accetti la volatilità del mercato delle criptovalute. <br />
                      3.15. Non soffri di dipendenza dal gioco d'azzardo. <br />
                      3.16. Non devi utilizzare software di terze parti. <br />
                      3.17. Confermi che i dati forniti sono corretti. <br />
                      3.17.1. Non puoi modificare i dati autonomamente, devi rivolgerti all'assistenza. <br />
                      3.18. Non utilizzerai il Servizio in giurisdizioni vietate. <br />
                      3.19. Dichiari che: <br />
                      - Utilizzi il Servizio esclusivamente a tuo nome; <br />
  ...
  sw: {
    ...
    pageTabTitle: "Jisajili kwa akaunti ya Goldbet Casino",
    backBtn: "Rudi",
    // | Step 1
    depToBalance: `<span><i class="actual-spin-amount">100</i> MIZUNGUKO BILA MALIPO</span>`,
    ...
    youWillGetFreeSpins: "Utapata mizunguko bila malipo",
    ...
    chickenRoadPlaying: "Inacheza",
    heroTitle: `pata bonasi yako <br/> <span class="text-[#30FF7E]"><i class="actual-spin-amount">100</i> mizunguko bila malipo</span> <br/> katika <span>big bass splash</span>`,
